...
public:
    ExportExcelObject(const QString &filepath, const QString &sheettitle,
                      QTableView *table_station):excelFilePath(filepath),
                      sheetName(sheettitle), tableView(table_station){}
...
public:
    ...
    void setTableView(QTableView *table_station) {tableView = table_station;}
