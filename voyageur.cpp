...
bool Voyageur:: ajouter()
{
    ...
    QString res1=QString::number(NUMERO_PASSEPORT);
     ...
     query.prepare("insert into VOYAGEURS(CIN_VOY,NOM_VOY,PRENOM_VOY,NUMERO_PASSEPORT,AGE_VOY,ORIGINE,GENRE)" "VALUES (:CIN_VOY,:NOM_VOY, :PRENOM_VOY , :NUMERO_PASSEPORT ,:AGE_VOY, :ORIGINE, :GENRE)");
